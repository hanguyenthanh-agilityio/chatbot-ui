...
export const COMPOSER_ATTACH_MENU_ITEM_CLASS = cn(
  "inline-flex h-auto w-full items-center justify-start gap-3 rounded-xl px-2.5 py-2 text-left font-normal transition-colors",
...
export const COMPOSER_ATTACH_TOGGLE_BUTTON_CLASS = cn(
  "grid h-10 w-10 min-h-10 min-w-10 shrink-0 place-items-center rounded-xl border p-0 transition-colors duration-200",
