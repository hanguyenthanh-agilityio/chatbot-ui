...
const CARD_VARIANT_CLASSES = {
  glass:
    "border border-white/10 bg-[linear-gradient(165deg,rgba(255,255,255,0.09),rgba(255,255,255,0.04))] shadow-[0_10px_30px_rgba(7,12,30,0.26)] backdrop-blur-md light:border-app-border-10 light:bg-[linear-gradient(165deg,rgba(255,255,255,0.95),rgba(248,245,255,0.88))] light:shadow-[0_10px_30px_rgba(76,56,140,0.12)]",
  panel:
