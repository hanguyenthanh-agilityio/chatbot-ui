...
export function MessageBubble({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl border border-white/11 bg-[linear-gradient(165deg,rgba(255,255,255,0.09),rgba(255,255,255,0.06))] px-4 py-2.5 text-sm leading-relaxed text-white/88 shadow-[0_8px_24px_rgba(6,10,30,0.24)] backdrop-blur-md",
